...
describe("Winning test", () => {

  it("when a team is eliminated, the other wins", () => {
    const game = makeTestGame();

    //random issue avoider
    game.grid[0][0].height = 1;
    game.grid[1][0].height = 1;
    ...
    expect(getWinner(result)).toBe("red");
  });
});
...
// invalid state test: this was suggested and immediately generated by chatGPT while debugging
